...
namespace AppKit2
{
    ...
    /// </summary>
    public class ArduinoSerial2 : MonoBehaviour
    {
...
//
        ...
        #region Singleton
        static ArduinoSerial2 _instance;

        public static ArduinoSerial2 Instance
        {
            get
            {
                if (_instance == null)
                {
                    var go = new GameObject(typeof(ArduinoSerial2).ToString());
                    DontDestroyOnLoad(go);
                    _instance = go.AddComponent<ArduinoSerial2>();
                }
                return _instance;
            }
        }
