...
[System.Serializable]
public class GetOffBigPlayableAsset : PlayableAsset
{
    ...
    public override Playable CreatePlayable(PlayableGraph graph, GameObject go)
    {
        ...
        var behaviour = new GetOffBigPlayableBehaviour();
        ...
        return ScriptPlayable<GetOffBigPlayableBehaviour>.Create(graph, behaviour);
    }
}
