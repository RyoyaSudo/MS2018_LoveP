...
[System.Serializable]
public class GetOffSmallPlayableAsset : PlayableAsset
{
    ...
    public override Playable CreatePlayable(PlayableGraph graph, GameObject go)
    {
        ...
        var behaviour = new GetOffSmallPlayableBehaviour();
        ...
        return ScriptPlayable<GetOffSmallPlayableBehaviour>.Create(graph, behaviour);
    }
}
