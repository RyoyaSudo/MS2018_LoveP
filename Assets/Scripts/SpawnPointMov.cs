...
public class SpawnPointMov : MonoBehaviour {

    /// <summary>
    /// 乗客の乗車順番
    /// </summary>
    public enum MOV_ORDER
    {
        FIRST = 0,       //最初
        DEFOULT          //それ以外
    }
    ...
    /// 乗客の乗車順番
    /// </param>
    public void MovSpawn(int spawnPointNum, PassengerController.GROUPTYPE groupType, MOV_ORDER passengerOrder)
    {
        // 生成
